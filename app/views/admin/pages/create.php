...
<form class="form" method="POST" action="/admin/pages/create" style="max-width:600px;">
    ...
    <div class="form__group">
        ...
        <span class="form__hint">Utilisé dans l'URL de l'article (ex: mon-article).</span>
    </div>

    <div class="form__group">
        <label class="form__label" for="content">Contenu</label>
        <textarea class="textarea" id="content" name="content" rows="12" maxlength="<?= \App\Models\Page::MAX_CONTENT_LENGTH ?>"></textarea>
