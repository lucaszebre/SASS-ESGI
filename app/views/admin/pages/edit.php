...
<form class="form" method="POST" action="/admin/pages/edit/<?= $page['id'] ?>" style="max-width:600px;">
    ...
    <div class="form__group">
        ...
        <textarea class="textarea" id="content" name="content" rows="10" maxlength="<?= \App\Models\Page::MAX_CONTENT_LENGTH ?>"><?= htmlspecialchars($page['content'], ENT_QUOTES, 'UTF-8') ?></textarea>
    </div>
